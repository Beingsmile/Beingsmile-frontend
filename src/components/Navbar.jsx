    ...
    <nav className="bg-white border-gray-200 dark:bg-gray-900">
      <div className="max-w-screen-xl flex flex-wrap items-center justify-between mx-auto p-4">
        ...
        <div className="flex items-center md:order-2 space-x-3 md:space-x-0 rtl:space-x-reverse">
          <button onClick={toggleTheme} aria-label={`Switch to ${theme === 'dark' ? 'light' : 'dark'} mode`} className="px-2 py-1 flex justify-center items-center text-center mr-2 rounded-full bg-gray-200 dark:bg-gray-800 hover:bg-gray-300 dark:hovertransition-colors transition-all duration-300">
            {
              theme === "dark" ? (
